...
/* Richiamo mia funzione,creata nel file functions.db.php */
db_insert_uta($uid);
...
/* query per poter scrivere task e studio nella tabella smt2_records */
$sql = 'update smt2_records set studio = '. $_SESSION['idstudio']. ' , task = '. $_SESSION['idtask']. ', where id = '.$uid.'';
